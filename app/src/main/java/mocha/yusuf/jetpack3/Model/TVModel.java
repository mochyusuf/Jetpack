...
public class TVModel implements Parcelable {
    ...
    public TVModel(String original_name, String name, double popularity, int vote_count, String first_air_date, String backdrop_path, String original_language, long id, String vote_average, String overview, String poster_path) {
